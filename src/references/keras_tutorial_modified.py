...
```
e.g.:
python keras_tutorial_modified.py contents/dancing.jpg texture/cracked_0162.jpg r
```
...
parser.add_argument('--content_weight', type=float, default=0.005, required=False,
                    help='Content weight.')
parser.add_argument('--style_weight', type=float, default=50.0, required=False,
                    help='Style weight.')
